...
$sql = "SELECT `sessions`.*,
    students.fullname, students.QR as student_qr, devices.Name, devices.QR as device_qr, CURRENT_TIMESTAMP() as `currenttime`, laboratories.laboratory
    FROM`sessions`,devices, students, class_sessions, laboratories
